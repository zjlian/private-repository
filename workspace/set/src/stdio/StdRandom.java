...
/**
 *  The {@code StdRandom} class 提供了用于生成的静态方法
 *  来自各种离散和连续分布的随机数，
 *  包括 Bernoulli, uniform, Gaussian, exponential, pareto,
 *  Poisson, and Cauchy. 它还提供了混洗阵列或子阵列的方法。
 */
public final class StdRandom {
    ...
    ///////////////////////////////////////////////////////////////////////////
    // 下面的静态方法仅依赖于 JAVA.UTIL.RANDOM ONLY INDIRECTLY VIA
    ...
    public static void main(String[] args) {
        ...
        stdio.println("seed = " + StdRandom.getSeed());
        for (int i = 0; i < n; i++) {
        	stdio.printf("%2d ",   uniform(100));
        	stdio.printf("%8.5f ", uniform(10.0, 99.0));
        	stdio.printf("%5b ",   bernoulli(0.5));
        	stdio.printf("%7.5f ", gaussian(9.0, 0.2));
        	stdio.printf("%1d ",   discrete(probabilities));
        	stdio.printf("%1d ",   discrete(frequencies));
            StdRandom.shuffle(a);
            for (String s : a)
            	stdio.print(s);
            stdio.println();
